...
3.	Below error while trying to push to git
...
4.	The CloudFormationExecutionRole has full AdminstratorAccess, still Glue role given in the nyc-taxi-infra.yaml file failed during the stack creation.
